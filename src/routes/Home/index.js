        ...
        <main className="home">
                        ...
                        <Slide top>
                            <div>
                                ...
                                <LinkContainer to={authUser ? ROUTES.DAYS : ROUTES.LOGIN}>
                                    <Button variant="outline-light">{authUser ? 'See Progress' : 'Login'}</Button>
                                </LinkContainer>
                            </div>
                        </Slide>
                    </Row>
            ...
            <Container className="my-5 pt-4 pb-3">
                <Reveal effect="fade-in">
                    ...
                    <LineChart data={weightGraphData} x="Month" y="Weight" interpolation="monotoneX"></LineChart>
                    ...
                    <Container>
                        <Reveal effect="fade-in">
                            ...
                            <Row className="text-white text-center">
                                ...
                                <Col md={3}>
                                    <h1 className="text-warning mb-1">1,898</h1>
                                    <p>Weight Lost</p>
                                </Col>
                            </Row>
                        </Reveal>
